...
function mockRequest(path: string, options: RequestOptions) {
  ...
  if (path === "api/v1/launcher/releases") return { version: "0.2.4", notes: "No update in the development harness.", publishedAt: new Date().toISOString(), supportedBudgetedRange: ">=0.1.0 <1.0.0", templateUrl: "https://example.com/releases/0.2.4/template.yaml", templateSha256: "a".repeat(64), apiSha256: "a".repeat(64), reconcilerSha256: "a".repeat(64), artifactsSha256: "a".repeat(64), runnerSha256: "a".repeat(64), rendererSha256: "a".repeat(64), signature: "development" };
